...
public class HistoryAdapter extends RecyclerView.Adapter<HistoryAdapter.ViewHolder>
{
     ...
     private ArrayList<HistoryModel> categoryModels;

    public HistoryAdapter(Context context, ArrayList<HistoryModel> categoryModels) {
    ...
    public HistoryAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View convertView = LayoutInflater.from(context).inflate(R.layout.stream_history,parent,false);
    ...
    public void onBindViewHolder(@NonNull HistoryAdapter.ViewHolder holder, int position) {
        ...
        HistoryModel categoryModel = categoryModels.get(position);
        holder.txtName.setText(categoryModel.getTitle());
        holder.txtTime.setText("Time: "+categoryModel.getTime()+" minutes");
        holder.txtDate.setText(categoryModel.getDate());
        holder.txtPoint.setText(String.format("%.2f",categoryModel.getPoint()));
...
//                context.startActivity(intent);
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements  View.OnClickListener {
        ...
        TextView txtName,txtTime,txtDate,txtPoint;
        ...
        public ViewHolder(@NonNull View convertView) {
            ...
            txtPoint = convertView.findViewById(R.id.txtPoint);
