...
public class FlashcardActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AnimatorSet setLeftIn = (AnimatorSet) AnimatorInflater.loadAnimator(this,R.animator.behind_card);
            activityFlashcardBinding.txtBehind.setVisibility(View.GONE);
        activityFlashcardBinding.btnFlip.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                activityFlashcardBinding.txtBehind.setVisibility(View.VISIBLE);
                if(flip==0){
                    ...
                    setRightOut.setTarget(activityFlashcardBinding.txtBehind);
                    setLeftIn.setTarget(activityFlashcardBinding.imgFront);
                    setRightOut.start();
                    setLeftIn.start();
                    flip=0;
                }
        ...
        activityFlashcardBinding.btnNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(numberQS<arrayList.size()-1){
                    ...
                    startActivity(new Intent(FlashcardActivity.this,FlashCardCompleteActivity.class).putExtra("Topic",categoryModel.getCategory()));
