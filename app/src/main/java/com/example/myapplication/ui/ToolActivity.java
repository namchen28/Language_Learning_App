...
import com.example.myapplication.ui.test.ListTestActivity;
...
public class ToolActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        activityToolBinding.rTest.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(ToolActivity.this, ListTestActivity.class));
            }
        });
